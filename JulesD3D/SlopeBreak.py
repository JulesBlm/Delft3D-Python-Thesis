...
* Make nice n clear repr string How do I make the pretty (HTML?) interactive reprs like PyVista and xarray? I need on of those
* Smoothen slope break direction independent
* Start from slopebreak depth instead of starting from inflow depth. This way sigma grid layers are equal between different slope scenarios

This approach is much better
1. Define depth of slope break as argument to class
2. Define length of upper slope as argument to class
3. At the grid-cell of this length, depth=depth of slope break
4. Line up from this point is upper (channel) slope
5. Line down from this point is lower (basin) slope
"""
